...
<body>
    <header>
        <table border="0" width="100%">
            <tr>
                <td style="border: 0px;" align="right" width="10%">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Lambang_Kabupaten_Balangan.png/177px-Lambang_Kabupaten_Balangan.png" width="40px" height="50px">
                </td>
        ...
        <hr>
        <p><span class="auto-style1"><strong>LAPORAN DATA BENDAHARA </strong></span></p>
    </header>
    <footer>
        <hr>
